...
class SmsService
{
    ...
    public static function JobSend($mobile, $template, $template_params)
    {
        //多种短信通道根据规则切换
        self::TencentCloudSMS($mobile, $template, $template_params);
    }

    // 短信
    public static function TencentCloudSMS($mobile, $template, $template_params)
    {
        ...
        $req->SmsSdkAppId = config('TENCENTCLOUD.APP_ID');
        /* 短信签名内容: 使用 UTF-8 编码，必须填写已审核通过的签名，签名信息可登录 [短信控制台] 查看 */
        $req->SignName = config('TENCENTCLOUD.SIGN_NAME');
